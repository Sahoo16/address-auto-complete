...
class Address_Auto_Complete_Loader {
  ...
  private function define_constants() {
    ...
    $this->define( 'RP_ADDRESS_AUTO_BASE', plugin_basename( RP_ADDRESS_AUTO_FILE ) );
   ...
   */
	public function delivery_fee_required_plugins() {
		...
		if ( ! is_plugin_active( 'restropress/restro-press.php' ) ) {
		  ...
		  echo '<div id="notice" class="error"><p>' . sprintf( __( ' Adress Auto Complete <a href="%1$s" target="_blank"> RestroPress </a> plugin to be installed. Please install and activate it', 'rp-address-auto-complete' ), esc_url( $plugin_link ) ).  '</p></div>';
   ...
   */
    ...
    $link = admin_url( 'admin.php?page=rpress-settings&tab=general&section=adress' );
