 ...
 * Description:       This plugin use for RestroPress to autocomplete the address at the product check out page.
 * Version:           1.0.0
 * Author:            magnigenie
...
if ( ! defined( 'RP_ADDRESS_AUTO_FILE' ) ) {

	define( 'RP_ADDRESS_AUTO_FILE', __FILE__ );
