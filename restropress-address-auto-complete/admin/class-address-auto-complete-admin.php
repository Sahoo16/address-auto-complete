...
class Address_Auto_Complete_Admin {
	...
	public function rpress_delivery_map_settings_section( $section ) {
		$section['adress'] = __( 'Address Auto Complete', 'rp-address-auto-complete' );
		return $section;
	}
	...
	public function rpress_add_delivery_settings( $general_settings ) {
		...
		$general_settings['adress']['adress_heading'] = array(
            ...
            'desc'          => '',
            'type'          => 'header',
            'tooltip_title' => __( ' API Key Setting', 'rp-address-auto-complete ' ),
        );
		$general_settings['adress']['auto_adress_enable'] = array(
            'id'            => 'auto_adress_enable',
            'name'          =>  __( 'Auto adress Enable', 'rp-address-auto-complete' ) ,
            'desc'          => __( 'Enable this if you want to add address autofill box at checkout','rp-address-auto-complete' ),
            'type'          => 'checkbox',
            'tooltip_title' => __( 'Auto adress Enable', 'rp-address-auto-complete ' ),
        );
		$general_settings['adress']['iput_label'] = array(
            'id'            => 'input_label',
        ...
        $general_settings['adress']['google_map_api_key'] = array(
            ...
            'desc'  => __( 'Add your Google map API for adress auto fill.', 'rp-address-auto-complete' ),
            'type'  => 'text',
        );	 
